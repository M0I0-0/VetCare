<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('appointments.show', $appointment) }}" class="text-teal-400 hover:text-teal-600 transition-colors">
    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-teal-100/60">
                ...
                <div class="mb-6">
                    <h3 class="text-lg font-extrabold text-teal-950">Actualizar Cita Veterinaria</h3>
                    <p class="text-xs text-gray-500 mt-1">Puedes cambiar el estado de la cita, reprogramar la fecha/hora, reasignar el veterinario u otros detalles.</p>
                </div>
                ...
                <form action="{{ route('appointments.update', $appointment) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select id="pet_id" name="pet_id" required class="w-full rounded-2xl bg-[#fbfbf8]/40 border border-teal-100/80 text-teal-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all font-semibold">
                                @foreach($pets as $pet)
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select id="user_id" name="user_id" required class="w-full rounded-2xl bg-[#fbfbf8]/40 border border-teal-100/80 text-teal-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all font-semibold">
                                @foreach($vets as $vet)
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="scheduled_at" name="scheduled_at"
                                ...
                                required
                                class="w-full rounded-2xl bg-[#fbfbf8]/40 border border-teal-100/80 text-teal-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all font-semibold">
                        ...
                        <div>
                            ...
                            <select id="reason" name="reason" required class="w-full rounded-2xl bg-[#fbfbf8]/40 border border-teal-100/80 text-teal-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all font-semibold">
                        ...
                        {{-- Status --}}
                        <div>
                            <label for="status" class="block text-xs font-bold text-teal-700 uppercase tracking-wider mb-2">Estado *</label>
                            <select id="status" name="status" required class="w-full rounded-2xl bg-[#fbfbf8]/40 border border-teal-100/80 text-teal-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all font-semibold">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                ...
                                class="w-full rounded-2xl bg-[#fbfbf8]/40 border border-teal-100/80 text-teal-950 text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all resize-none font-semibold">{{ old('notes', $appointment->notes) }}</textarea>
                    ...
                    <div class="flex items-center justify-between pt-5 border-t border-teal-50">
                        <a href="{{ route('appointments.show', $appointment) }}" class="inline-flex items-center px-4 py-2 border border-teal-200 text-teal-600 font-bold text-sm rounded-2xl hover:bg-teal-50 transition-all shadow-sm">
                            Cancelar
                        </a>
