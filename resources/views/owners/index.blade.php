    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-extrabold text-2xl text-purple-950 leading-tight flex items-center gap-2.5">
                ...
                <span>{{ __('Directorio de Dueños') }}</span>
            </h2>
                                    ...
                                    <tr class="hover:bg-purple-50/20 transition-colors">
                                        ...
                                        <td class="py-4 px-6">
                                            <div class="flex flex-col">
                                                <span class="text-purple-950 font-bold flex items-center gap-1.5">
                                                    <svg class="h-4 w-4 text-purple-450 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                                    </svg>
                                                    {{ $owner->email }}
                                                </span>
                                                <span class="text-xs text-gray-500 mt-1 font-semibold flex items-center gap-1.5">
                                                    <svg class="h-3.5 w-3.5 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2">
                                        ...
                                        <td class="py-4 px-6 text-center">
                                            <span class="inline-flex items-center px-3.5 py-1.5 rounded-full text-xs font-extrabold bg-purple-50 text-purple-700 border border-[#e2d8f7] shadow-3xs gap-1.5">
                                                <img src="{{ asset('images/logos/logo_vetcare.jpg') }}" class="h-3.5 w-3.5 rounded-full object-cover" alt="Mascota">
                                                <span>{{ $owner->pets_count }} mascota{{ $owner->pets_count !== 1 ? 's' : '' }}</span>
                                            </span>
                                        </td>
                                        <td class="py-4 px-6 text-right space-x-2 whitespace-nowrap">
                                            <a href="{{ route('owners.show', $owner) }}" class="inline-flex items-center px-3 py-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200/50 rounded-xl transition-all shadow-3xs text-xs font-bold gap-1" title="Ver Detalle">
                                            ...
                                            @if(Auth::user()->role === 'admin')
                                                <a href="{{ route('owners.edit', $owner) }}" class="inline-flex items-center px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200/50 rounded-xl transition-all shadow-3xs text-xs font-bold gap-1" title="Editar">
                                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
